...
def tnoStacker(oribits_obj, obj):
    ...
    #depth-1 maps
    path = '/home/snaess/project/actpol/maps/depth1/release/'
...
class minorplanet():
    ...
    '''
    def __init__(self, name, obs = 'W99', t_start ='2010-01-01T00:00:00', t_end='2020-01-01T00:00:00'):
        '''
